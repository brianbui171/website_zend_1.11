...
class Zend_Dojo_BuildLayer {
	 ...
	 * @var array
	 */
	protected $_profileOptions = array ('action' => 'release', 'optimize' => 'shrinksafe', 'layerOptimize' => 'shrinksafe', 'copyTests' => false, 'loader' => 'default', 'cssOptimize' => 'comments' );
	...
	public function generateBuildProfile() {
		...
		$profile ['layers'] = array (array ('name' => $layerScriptPath, 'layerDependencies' => array (), 'dependencies' => array ($layerName ) ) );
