...
class Zend_Tool_Project_Context_Content_Engine {
	...
	public function __construct(Zend_Tool_Framework_Client_Storage $storage) {
		...
		$this->_engines = array (new Zend_Tool_Project_Context_Content_Engine_CodeGenerator ( $storage, $this->_keyInStorage ), new Zend_Tool_Project_Context_Content_Engine_Phtml ( $storage, $this->_keyInStorage ) );
	}
