...
class Zend_Queue_Adapter_Array extends Zend_Queue_Adapter_AdapterAbstract {
	...
	public function send($message, Zend_Queue $queue = null) {
		...
		// create the message
		$data = array ('message_id' => md5 ( uniqid ( rand (), true ) ), 'body' => $message, 'md5' => md5 ( $message ), 'handle' => null, 'created' => time (), 'queue_name' => $queue->getName () );
	...
	public function getCapabilities() {
		return array ('create' => true, 'delete' => true, 'send' => true, 'receive' => true, 'deleteMessage' => true, 'getQueues' => true, 'count' => true, 'isExists' => true );
	}
