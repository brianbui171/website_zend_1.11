...
class Zend_Queue_Adapter_PlatformJobQueue extends Zend_Queue_Adapter_AdapterAbstract {
	...
	public function receive($maxMessages = null, $timeout = null, Zend_Queue $queue = null) {
		...
		$options = array ('queue' => $this->_queue, 'data' => $jobs, 'messageClass' => $this->_queue->getMessageClass () );
	...
	public function getCapabilities() {
		return array ('create' => false, 'delete' => false, 'getQueues' => false, 'isExists' => false, 'count' => true, 'send' => true, 'receive' => true, 'deleteMessage' => true );
	}
