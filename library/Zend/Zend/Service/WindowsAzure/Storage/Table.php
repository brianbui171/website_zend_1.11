...
class Zend_Service_WindowsAzure_Storage_Table extends Zend_Service_WindowsAzure_Storage_BatchStorageAbstract {
	...
	public function createTable($tableName = '') {
		...
		$requestBody = $this->_fillTemplate ( $requestBody, array ('BaseUrl' => $this->getBaseUrl (), 'TableName' => htmlspecialchars ( $tableName ), 'Updated' => $this->isoDate (), 'AccountName' => $this->_accountName ) );
	...
	public function insertEntity($tableName = '', Zend_Service_WindowsAzure_Storage_TableEntity $entity = null) {
		...
		$requestBody = $this->_fillTemplate ( $requestBody, array ('Updated' => $this->isoDate (), 'Properties' => $this->_generateAzureRepresentation ( $entity ) ) );
