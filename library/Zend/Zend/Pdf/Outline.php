...
abstract class Zend_Pdf_Outline implements RecursiveIterator, Countable {
	...
	public function getOptions() {
		return array ('title' => $this->_title, 'open' => $this->_open, 'color' => $this->_color, 'italic' => $this->_italic, 'bold' => $this->_bold, 'target' => $this->_target );
	}
	...
	public static function create($param1, $param2 = null) {
		...
		if (is_string ( $param1 )) {
			...
			return new Zend_Pdf_Outline_Created ( array ('title' => $param1, 'target' => $param2 ) );
		} else {
