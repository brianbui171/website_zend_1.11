...
class Zend_View_Helper_HeadTitle extends Zend_View_Helper_Placeholder_Container_Standalone {
	...
	public function setDefaultAttachOrder($setType) {
		if (! in_array ( $setType, array (Zend_View_Helper_Placeholder_Container_Abstract::APPEND, Zend_View_Helper_Placeholder_Container_Abstract::SET, Zend_View_Helper_Placeholder_Container_Abstract::PREPEND ) )) {
