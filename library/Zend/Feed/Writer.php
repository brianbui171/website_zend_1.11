...
class Zend_Feed_Writer {
	 ...
	 * @var array
	 */
	protected static $_extensions = array ('entry' => array (), 'feed' => array (), 'entryRenderer' => array (), 'feedRenderer' => array () );
	...
	public static function getPluginLoader() {
		if (! isset ( self::$_pluginLoader )) {
			...
			self::$_pluginLoader = new Zend_Loader_PluginLoader ( array ('Zend_Feed_Writer_Extension_' => 'Zend/Feed/Writer/Extension/' ) );
		}
