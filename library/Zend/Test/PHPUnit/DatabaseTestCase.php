...
abstract class Zend_Test_PHPUnit_DatabaseTestCase extends PHPUnit_Extensions_Database_TestCase {
	...
	protected function getSetUpOperation() {
		return new PHPUnit_Extensions_Database_Operation_Composite ( array (new Zend_Test_PHPUnit_Db_Operation_Truncate (), new Zend_Test_PHPUnit_Db_Operation_Insert () ) );
	}
