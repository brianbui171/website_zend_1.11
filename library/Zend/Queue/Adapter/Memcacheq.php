...
class Zend_Queue_Adapter_Memcacheq extends Zend_Queue_Adapter_AdapterAbstract {
	...
	public function receive($maxMessages = null, $timeout = null, Zend_Queue $queue = null) {
		...
		if ($maxMessages > 0) {
			for($i = 0; $i < $maxMessages; $i ++) {
				$data = array ('handle' => md5 ( uniqid ( rand (), true ) ), 'body' => $this->_cache->get ( $queue->getName () ) );
	...
	public function getCapabilities() {
		return array ('create' => true, 'delete' => true, 'send' => true, 'receive' => true, 'deleteMessage' => false, 'getQueues' => true, 'count' => false, 'isExists' => true );
	}
