...
class Zend_Service_DeveloperGarden_ConferenceCall extends Zend_Service_DeveloperGarden_Client_ClientAbstract {
	...
	public function createConference($ownerId, Zend_Service_DeveloperGarden_ConferenceCall_ConferenceDetail $conferenceDetails, Zend_Service_DeveloperGarden_ConferenceCall_ConferenceSchedule $conferenceSchedule = null, $account = null) {
		...
		$result = $this->getSoapClient ()->createConference ( array ('createConferenceRequest' => $request ) );
	...
	public function commitConference($conferenceId) {
		...
		$result = $this->getSoapClient ()->commitConference ( array ('commitConferenceRequest' => $request ) );
	...
	public function updateConference($conferenceId, $ownerId = null, Zend_Service_DeveloperGarden_ConferenceCall_ConferenceDetail $conferenceDetails = null, Zend_Service_DeveloperGarden_ConferenceCall_ConferenceSchedule $conferenceSchedule = null, $account = null) {
		...
		$result = $this->getSoapClient ()->updateConference ( array ('updateConferenceRequest' => $request ) );
	...
	public function getConferenceStatus($conferenceId, $what = 0) {
		...
		$result = $this->getSoapClient ()->getConferenceStatus ( array ('getConferenceStatusRequest' => $request ) );
	...
	public function getRunningConference($conferenceId) {
		...
		$result = $this->getSoapClient ()->getRunningConference ( array ('getRunningConferenceRequest' => $request ) );
	...
	public function removeConference($conferenceId) {
		...
		$result = $this->getSoapClient ()->removeConference ( array ('removeConferenceRequest' => $request ) );
	...
	public function getConferenceList($what = 0, $ownerId = null) {
		...
		$result = $this->getSoapClient ()->getConferenceList ( array ('getConferenceListRequest' => $request ) );
	...
	public function newParticipant($conferenceId, Zend_Service_DeveloperGarden_ConferenceCall_ParticipantDetail $participant) {
		...
		$result = $this->getSoapClient ()->newParticipant ( array ('newParticipantRequest' => $request ) );
	...
	public function getParticipantStatus($conferenceId, $participantId) {
		...
		$result = $this->getSoapClient ()->getParticipantStatus ( array ('getParticipantStatusRequest' => $request ) );
	...
	public function removeParticipant($conferenceId, $participantId) {
		...
		$result = $this->getSoapClient ()->removeParticipant ( array ('removeParticipantRequest' => $request ) );
	...
	public function updateParticipant($conferenceId, $participantId, $action = null, Zend_Service_DeveloperGarden_ConferenceCall_ParticipantDetail $participant = null) {
		...
		$result = $this->getSoapClient ()->updateParticipant ( array ('updateParticipantRequest' => $request ) );
	...
	public function createConferenceTemplate($ownerId, Zend_Service_DeveloperGarden_ConferenceCall_ConferenceDetail $conferenceDetails, array $participants = null) {
		...
		$result = $this->getSoapClient ()->createConferenceTemplate ( array ('createConferenceTemplateRequest' => $request ) );
	...
	public function getConferenceTemplate($templateId) {
		...
		$result = $this->getSoapClient ()->getConferenceTemplate ( array ('getConferenceTemplateRequest' => $request ) );
	...
	public function updateConferenceTemplate($templateId, $initiatorId = null, Zend_Service_DeveloperGarden_ConferenceCall_ConferenceDetail $conferenceDetails = null) {
		...
		$result = $this->getSoapClient ()->updateConferenceTemplate ( array ('updateConferenceTemplateRequest' => $request ) );
	...
	public function removeConferenceTemplate($templateId) {
		...
		$result = $this->getSoapClient ()->removeConferenceTemplate ( array ('removeConferenceTemplateRequest' => $request ) );
	...
	public function getConferenceTemplateList($ownerId) {
		...
		$result = $this->getSoapClient ()->getConferenceTemplateList ( array ('getConferenceTemplateListRequest' => $request ) );
	...
	public function addConferenceTemplateParticipant($templateId, Zend_Service_DeveloperGarden_ConferenceCall_ParticipantDetail $participant) {
		...
		$result = $this->getSoapClient ()->addConferenceTemplateParticipant ( array ('addConferenceTemplateParticipantRequest' => $request ) );
	...
	public function getConferenceTemplateParticipant($templateId, $participantId) {
		...
		$result = $this->getSoapClient ()->getConferenceTemplateParticipant ( array ('getConferenceTemplateParticipantRequest' => $request ) );
	...
	public function updateConferenceTemplateParticipant($templateId, $participantId, Zend_Service_DeveloperGarden_ConferenceCall_ParticipantDetail $participant) {
		...
		$result = $this->getSoapClient ()->updateConferenceTemplateParticipant ( array ('updateConferenceTemplateParticipantRequest' => $request ) );
	...
	public function removeConferenceTemplateParticipant($templateId, $participantId) {
		...
		$result = $this->getSoapClient ()->removeConferenceTemplateParticipant ( array ('removeConferenceTemplateParticipantRequest' => $request ) );
