...
class Image {
	...
	var $chmod = 0755;
	var $_imgInfoOrig = array ('name' => '', 'ext' => '', 'size' => '', 'width' => '', 'height' => '', 'type' => '', 'path' => '' );
	var $_imgInfoFinal = array ('name' => '', 'ext' => '', 'size' => '', 'width' => '', 'height' => '', 'type' => '', 'path' => '' );
	var $_imgQuality = 90;
	/**
	 * constructor
	 *
	...
	function loadImage($filename) {
		...
		if ($this->_imgOrig == null) {
			...
			$this->_imgInfoOrig = array ('name' => basename ( $filename ), 'ext' => $ext, 'size' => filesize ( $filename ), 'path' => $filename );
	...
	function getGDInfo($versionOnly = false) {
		...
		if (function_exists ( 'gd_info' )) {
			...
			$gd = array ('GD Version' => '', 'GIF Read Support' => false, 'GIF Create Support' => false, 'JPG Support' => false, 'PNG Support' => false, 'FreeType Support' => false, 'FreeType Linkage' => '', 'T1Lib Support' => false, 'WBMP Support' => false, 'XBM Support' => false );
			ob_start ();
			phpinfo ();
