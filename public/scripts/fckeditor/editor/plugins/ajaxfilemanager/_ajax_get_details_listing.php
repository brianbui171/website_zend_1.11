...
<table class="tableList" id="tableList" cellpadding="0" cellspacing="0"
	...
	<thead>
		<tr>
			...
			<th class="docName"><?php
			echo LBL_NAME;
			?></th>
			<th width="70" class="fileColumns"><?php
			echo LBL_SIZE;
			?></th>
			<th class="fileColumns"><?php
			echo LBL_MODIFIED;
			?></th>
		</tr>
	</thead>
	<tbody id="fileList">
			...
			<td align="center" id="tdz<?php
				...
				id="flag<?php
								...
								echo $file ['flag'];
								?>">&nbsp;</span><input
				type="checkbox" name="check[]" id="cb<?php
								echo $count;
								?>"
				value="<?php
								echo $file ['path'];
			...
			<td align="center" class="fileColumns" id="tdst<?php
								echo $count;
								?>">&nbsp;<a
				id="a<?php
								echo $count;
			...
			<td lign="center" class="fileColumns" id="tdst<?php
								echo $count;
								?>">&nbsp;<a
				id="a<?php
								echo $count;
								...
								?>"
				<?php
								echo $file ['cssClass'] == 'filePicture' ? 'rel="ajaxPhotos"' : '';
								?>><span
				class="<?php
								echo ($file ['file'] || $file ['subdir'] ? $file ['cssClass'] : "folderEmpty");
								?>">&nbsp;</span></a></td>
			<td class="<?php
								echo $strClass;
								?> docName"
